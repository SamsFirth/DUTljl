...
from joyaiSFT.server.schemas.assistants.assistants import AssistantCreate, AssistantObject, AssistantModify
...
class AssistantDatabaseManager:
    ...
    def create_assistant_object(self, assistant: AssistantCreate) -> AssistantObject:
        assistant = AssistantObject(**assistant.model_dump(mode='json'), id=str(uuid4()), object='assistant', created_at=int(time()))
        return assistant
