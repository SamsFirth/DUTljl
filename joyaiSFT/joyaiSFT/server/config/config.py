...
import yaml
import psutil
from joyaiSFT.server.config.singleton import Singleton
...
class Config(metaclass=Singleton):
    ...
    def load() -> dict:
        ...
        localstore_path: str = os.path.join(user_path, '.joyaiSFT')
    ...
    def __init__(self):
        ...
        self.localstore_path: str = os.path.join(self.user_path, '.joyaiSFT')
        ...
        self.optimize_config_path: Optional[str] = self.model.get('optimize_config_path', None)
        ...
        self.utilization_percentage = 1.0
