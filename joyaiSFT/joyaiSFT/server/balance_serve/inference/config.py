...
class ModelConfig:
    ...
    json_key_map = {'vocab_size': 'vocab_size', 'n_layer': 'num_hidden_layers', 'n_head': 'num_attention_heads', 'dim': 'hidden_size', 'intermediate_size': 'intermediate_size', 'n_local_heads': 'num_key_value_heads', 'rope_base': 'rope_theta', 'norm_eps': 'norm_eps', 'rms_norm_eps': 'rms_norm_eps', 'hidden_act': 'hidden_act'}
