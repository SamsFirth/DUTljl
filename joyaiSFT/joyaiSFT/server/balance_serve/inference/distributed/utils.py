...
class StatelessProcessGroup:
    ...
    @staticmethod
    def create(host: str, port: int, rank: int, world_size: int, data_expiration_seconds: int=3600) -> 'StatelessProcessGroup':
        ...
        """
        store = TCPStore(host_name=host, port=port, world_size=world_size, is_master=rank == 0)
        return StatelessProcessGroup(rank=rank, world_size=world_size, store=store, data_expiration_seconds=data_expiration_seconds)