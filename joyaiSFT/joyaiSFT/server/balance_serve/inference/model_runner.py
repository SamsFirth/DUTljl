...
from joyaiSFT.models.custom_modeling_chatrhinoV0_v2 import JOYChatrhinoV0ForCausalLM
...
class ModelRunner:
    ...
    def sync(self, calc_time=True):
        ...
        if calc_time:
            self.model_time = self.start_model_event.elapsed_time(self.end_model_event)