...
from joyaiSFT.server.schemas.base import TODO, Metadata, MetadataField, ObjectWithCreatedTime
from joyaiSFT.server.schemas.assistants.threads import ThreadCreate
from joyaiSFT.server.schemas.assistants.tool import Tool, ToolResource
...
class RunObject(RunBase, ObjectWithCreatedTime):
    ...
    def sync_db(self):
        sql_utils = SQLUtil()
        db_run = Run(**self.model_dump(mode='json'))
