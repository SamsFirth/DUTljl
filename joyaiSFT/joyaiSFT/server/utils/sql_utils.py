...
from joyaiSFT.server.exceptions import db_exception
    ...
    def init_engine(cfg: Config):
        ...
        if SQLUtil.sqlalchemy_engine is None:
            if cfg.db_type == 'sqllite':
                ...
                exit(-1)
            SQLUtil.sqlalchemy_engine = create_engine(db_url, connect_args={'check_same_thread': False}, pool_size=pool_size)
