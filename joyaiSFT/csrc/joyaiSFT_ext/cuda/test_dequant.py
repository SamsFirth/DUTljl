import os
import sys
sys.path.insert(0, '/home/zbx/joyaiSFT')
from joyaiSFT.util.custom_loader import GGUFLoader
import torch
gguf_loader_1 = GGUFLoader('/mnt/data/model/Chatrhino-q4km-gguf')
gguf_loader_2 = GGUFLoader('/mnt/data/chenht/model/gguf_for_joyaiSFT/DeepSeek-V3-bf16/')
