...
TYPES_MMQ = ['GGML_TYPE_Q4_0', 'GGML_TYPE_Q4_1', 'GGML_TYPE_Q5_0', 'GGML_TYPE_Q5_1', 'GGML_TYPE_Q8_0', 'GGML_TYPE_Q2_K', 'GGML_TYPE_Q3_K', 'GGML_TYPE_Q4_K', 'GGML_TYPE_Q5_K', 'GGML_TYPE_Q6_K']
    ...
    for cols_per_block in [8, 16, 32]:
        ...
        with open(f'fattn-wmma-f16-instance-kq{kq_acc_t}-cpb{cols_per_block}.cu', 'w') as f:
            ...
            for head_size in [64, 80, 96, 112, 128, 256]:
                if cols_per_block == 8 and head_size % 32 != 0:
                    continue
                if kq_acc_t == 'float' and cols_per_block == 32 and (head_size == 256):
                    continue
