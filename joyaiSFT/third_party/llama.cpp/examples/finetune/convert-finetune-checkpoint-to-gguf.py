...
class LoraParams:
    ...
    def load(self, data, offset):
        self.n_rank_attention_norm = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_wq = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_wk = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_wv = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_wo = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_ffn_norm = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_w1 = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_w2 = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_w3 = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_tok_embeddings = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_norm = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        self.n_rank_output = struct.unpack('<I', bytes(data[offset:offset + 4]))[0]
        offset += 4
        return offset
