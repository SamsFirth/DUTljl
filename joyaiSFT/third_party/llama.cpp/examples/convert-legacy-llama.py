...
class OutputFile:
    ...
    @staticmethod
    def write_vocab_only(fname_out: Path, params: Params, vocab: Vocab, svocab: gguf.SpecialVocab, endianess: gguf.GGUFEndian=gguf.GGUFEndian.LITTLE, pad_vocab: bool=False, metadata: Metadata=None) -> None:
    ...
    @staticmethod
    def write_all(fname_out: Path, ftype: GGMLFileType, params: Params, model: LazyModel, vocab: BaseVocab, svocab: gguf.SpecialVocab, concurrency: int=DEFAULT_CONCURRENCY, endianess: gguf.GGUFEndian=gguf.GGUFEndian.LITTLE, pad_vocab: bool=False, metadata: Metadata=None) -> None:
        check_vocab_size(params, vocab, pad_vocab=pad_vocab)
        of = OutputFile(fname_out, endianess=endianess)
        of.add_meta_model(params, metadata)
        of.add_meta_arch(params)
...
def default_convention_outfile(file_type: GGMLFileType, params: Params, model_params_count: int, metadata: Metadata) -> str:
    quantization = {GGMLFileType.AllF32: 'F32', GGMLFileType.MostlyF16: 'F16', GGMLFileType.MostlyQ8_0: 'Q8_0'}[file_type]
...
def main(args_in: list[str] | None=None) -> None:
    ...
    if args.get_outfile:
        ...
        print(f'{default_convention_outfile(ftype, params, model_params_count, metadata)}')
        return
