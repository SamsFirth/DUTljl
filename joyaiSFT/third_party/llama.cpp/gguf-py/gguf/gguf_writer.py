...
import numpy as np
from .constants import GGUF_DEFAULT_ALIGNMENT, GGUF_MAGIC, GGUF_VERSION, GGMLQuantizationType, GGUFEndian, GGUFValueType, Keys, RopeScalingType, PoolingType, TokenType
...
class GGUFWriter:
    ...
    def __init__(self, path: os.PathLike[str] | str | None, arch: str, use_temp_file: bool=False, endianess: GGUFEndian=GGUFEndian.LITTLE):
        self.fout = None
        self.path = path
        self.arch = arch
