...
class LibLlama:
    ...
    DEFAULT_PATH_LIBLLAMA = './build/libllama.so'
...
def generator_random_added_tokens(tokenizer, iterations=100) -> Iterator[str]:
    ...
    for m in range(iterations):
        ...
        if words[0] == tokenizer.bos_token:
...
def main(argv: list[str]=None):
    ...
    test_compare_tokenizer(func_tokenize1, func_tokenize2, generator_random_added_tokens(tokenizer, 10000))
    test_compare_tokenizer(func_tokenize1, func_tokenize2, generator_random_chars(10000))
    test_compare_tokenizer(func_tokenize1, func_tokenize2, generator_random_vocab_chars(vocab, 10000))
    test_compare_tokenizer(func_tokenize1, func_tokenize2, generator_random_vocab_words(vocab, 5000))
    model.free()
if __name__ == '__main__':
    path_tokenizers = './models/tokenizers/'
    path_vocab_format = './models/ggml-vocab-%s.gguf'
    tokenizers = ['llama-spm', 'phi-3', 'jina-v2-en', 'bert-bge']
