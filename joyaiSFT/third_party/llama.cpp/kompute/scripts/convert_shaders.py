...
@click.command()
@click.option('--shader-path', '-p', envvar='KOMPUTE_SHADER_PATH', required=True, help='The path for the directory to build and convert shaders')
@click.option('--shader-binary', '-s', envvar='KOMPUTE_SHADER_BINARY', required=True, help='The path for the directory to build and convert shaders')
@click.option('--header-path', '-c', envvar='KOMPUTE_HEADER_PATH', default='', required=False, help='The (optional) output file for the cpp header files')
@click.option('--verbose', '-v', envvar='KOMPUTE_HEADER_PATH', default=False, is_flag=True, help='Enable versbosity if flag is provided')
def run_cli(shader_path: str=None, shader_binary: str=None, header_path: bool=None, verbose: bool=None):
    """
