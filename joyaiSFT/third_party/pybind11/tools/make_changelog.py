...
missing = []
cats_descr = {'feat': 'New Features', 'feat(types)': '', 'feat(cmake)': '', 'fix': 'Bug fixes', 'fix(types)': '', 'fix(cmake)': '', 'docs': 'Documentation', 'tests': 'Tests', 'ci': 'CI', 'chore': 'Other', 'unknown': 'Uncategorised'}
