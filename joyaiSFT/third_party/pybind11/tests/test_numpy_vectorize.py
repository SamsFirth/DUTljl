...
def test_type_selection():
    ...
    assert m.selective_func(np.array([1j], dtype=np.complex64)) == 'Complex float branch taken.'
...
def test_trivial_broadcasting():
    ...
    assert trivial.c_trivial == vectorized_is_trivial(np.array([[1, 3, 5], [7, 9, 11]]), np.array([[2, 4, 6], [8, 10, 12]]), 3)
...
def test_passthrough_arguments(doc):
    assert doc(m.vec_passthrough) == 'vec_passthrough(' + ', '.join(['arg0: float', 'arg1: numpy.ndarray[numpy.float64]', 'arg2: numpy.ndarray[numpy.float64]', 'arg3: numpy.ndarray[numpy.int32]', 'arg4: int', 'arg5: m.numpy_vectorize.NonPODClass', 'arg6: numpy.ndarray[numpy.float64]']) + ') -> object'
    b = np.array([[10, 20, 30]], dtype='float64')
    c = np.array([100, 200])
    d = np.array([[1000], [2000], [3000]], dtype='int')
    g = np.array([[1000000, 2000000, 3000000]], dtype='int')
    assert np.all(m.vec_passthrough(1, b, c, d, 10000, m.NonPODClass(100000), g) == np.array([[1111111, 2111121, 3111131], [1112111, 2112121, 3112131], [1113111, 2113121, 3113131]]))
