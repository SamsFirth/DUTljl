...
def _get_workspace_dir_name() -> pathlib.Path:
    try:
        with warnings.catch_warnings():
            warnings.filterwarnings('ignore', '.*TORCH_CUDA_ARCH_LIST.*', module='torch')
...
CUTLASS_INCLUDE_DIRS = [_package_root / 'data' / 'cutlass' / 'include', _package_root / 'data' / 'cutlass' / 'tools' / 'util' / 'include']