...
def export_to_perfetto_trace(profiler_buffer: torch.Tensor, event_names: List[str], file_name: str) -> None:
    ...
    for i in range(1, len(profiler_buffer_host)):
        ...
        block_idx, group_idx, event_idx, event_type = decode_tag(tag, num_blocks, num_groups)
