...
class ReductionImplBase(StoreImplBase):
    ...
    def get_reduce_identity(self):
        ...
        """
        maxes = {DataType.f32: 2 ** 31 - 1, DataType.f16: 2 ** 15, DataType.s32: 2 ** 31 - 1, DataType.s8: 2 ** 7 - 1}
        mins = {DataType.f32: -maxes[DataType.f32], DataType.f16: -maxes[DataType.f16], DataType.s32: -maxes[DataType.s32], DataType.s8: -maxes[DataType.s8]}
    ...
    def argument_type(self):
        ...
        class _Argument(ctypes.Structure):
            _fields_ = [('ptr', ctypes.c_void_p), ('reduce_identity', dtype2ctype[element_compute]), ('dMNL', tuple_type)]
