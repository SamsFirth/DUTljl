...
dtype2ctype = {DataType.f16: ctypes.c_uint16, DataType.f32: ctypes.c_float, DataType.f64: ctypes.c_double, DataType.s8: ctypes.c_int8, DataType.s32: ctypes.c_int32}
...
class LinearCombination(EpilogueFunctorBase):
    ...
    def __init__(self, element_output, epilogue_vector_length, element_accumulator=None, element_epilogue=None) -> None:
        ...
        self.template_arguments = [DataTypeTag[element_output], str(epilogue_vector_length), DataTypeTag[element_accumulator], DataTypeTag[element_epilogue]]
        ...
        class _EpilogueOutputOpParamsEVT(ctypes.Structure):
            ...
            _fields_ = [('alpha', c_element_epilogue), ('beta', c_element_epilogue), ('alpha_ptr', ctypes.c_void_p), ('beta_ptr', ctypes.c_void_p), ('dalpha', stride_type), ('dbeta', stride_type)]
        ...
        class _EpilogueOutputOpParams(ctypes.Structure):
            _fields_ = [('alpha', c_element_epilogue), ('beta', c_element_epilogue), ('alpha_ptr', ctypes.c_void_p), ('beta_ptr', ctypes.c_void_p), ('alpha_ptr_array', ctypes.c_void_p), ('beta_ptr_array', ctypes.c_void_p)]
...
class LinearCombinationClamp(LinearCombination):
    ...
    def __init__(self, element_output, epilogue_vector_length, element_accumulator=None, element_epilogue=None) -> None:
        super().__init__(element_output, epilogue_vector_length, element_accumulator, element_epilogue)
        c_element_epilogue = dtype2ctype[self.element_epilogue]
        element_epilogue = self.element_epilogue

        class _EpilogueOutputOpParams(ctypes.Structure):
            _fields_ = [('alpha', c_element_epilogue), ('beta', c_element_epilogue), ('alpha_ptr', ctypes.c_void_p), ('beta_ptr', ctypes.c_void_p)]
...
class LinearCombinationGeneric(LinearCombination):
    ...
    def __init__(self, activation_functor, element_output, epilogue_vector_length, element_accumulator=None, element_epilogue=None) -> None:
        super().__init__(element_output, epilogue_vector_length, element_accumulator, element_epilogue)
...
class leaky_relu(ActivationFunctor, metaclass=leakyReLUMeta):
    ...
    def epilogue_output_op(element_epilogue):
        ...
        class _EpilogueOutputOpParams(ctypes.Structure):
            _fields_ = [('alpha', c_element_epilogue), ('beta', c_element_epilogue), ('alpha_ptr', ctypes.c_void_p), ('beta_ptr', ctypes.c_void_p), ('leaky_alpha', c_element_epilogue)]
