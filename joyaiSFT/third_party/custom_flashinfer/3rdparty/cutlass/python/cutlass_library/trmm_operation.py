...
class TrmmOperation:
    ...
    def __init__(self, trmm_kind, arch, tile_description, A, B, C, element_epilogue, epilogue_functor=EpilogueFunctor.LinearCombination, swizzling_functor=SwizzlingFunctor.Identity8):
...
class EmitTrmmConfigurationLibrary:
    ...
    def __init__(self, operation_path, configuration_name):
        ...
        self.instance_emitter = {TrmmKind.Universal: EmitTrmmUniversalInstance}
        self.trmm_kind_wrappers = {TrmmKind.Universal: 'TrmmOperation'}
        self.instance_template = {TrmmKind.Universal: '\n${compile_guard_start}\n  manifest.append(new ${trmm_kind}<\n    Operation_${operation_name}\n  >("${operation_name}"));\n${compile_guard_end}\n'}
