...
class Conv3dOperation:
    ...
    def __init__(self, conv_kind, iterator_algorithm, arch, tile_description, A, B, C, element_epilogue, stride_support, epilogue_functor=EpilogueFunctor.LinearCombination, swizzling_functor=SwizzlingFunctor.Identity4):
    ...
    def core_name(self):
        ...
        if self.tile_description.math_instruction.opcode_class == OpcodeClass.TensorOp:
            ...
            inst_shape = ''
        return '%s%s%s%s3d_%s' % (ShortDataTypeNames[self.tile_description.math_instruction.element_accumulator], inst_shape, intermediate_type, ConvKindNames[self.conv_kind], IteratorAlgorithmNames[self.iterator_algorithm])
    ...
    def configuration_name(self):
        ...
        return SubstituteTemplate(configuration_name, {'opcode_class': opcode_class_name, 'extended_name': self.extended_name(), 'threadblock': threadblock})
