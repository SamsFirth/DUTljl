...
class EmitRank2KConfigurationLibrary:
    ...
    def __init__(self, operation_path, configuration_name):
        ...
        self.instance_emitter = {RankKKind.Universal: EmitRank2KUniversalInstance}
        self.rank_k_kind_wrappers = {RankKKind.Universal: 'Rank2KOperation'}
