...
class DataType(enum.Enum):
    ...
    cu64 = enum_auto()
    invalid = enum_auto()
ShortDataTypeNames = {DataType.s32: 'i', DataType.e4m3: 'e4m3', DataType.e5m2: 'e5m2', DataType.f16: 'h', DataType.f32: 's', DataType.f64: 'd', DataType.cf32: 'c', DataType.cf64: 'z'}
DataTypeNames = {DataType.void: 'void', DataType.b1: 'b1', DataType.u2: 'u2', DataType.u4: 'u4', DataType.u8: 'u8', DataType.u16: 'u16', DataType.u32: 'u32', DataType.u64: 'u64', DataType.s4: 's4', DataType.s8: 's8', DataType.s16: 's16', DataType.s32: 's32', DataType.s64: 's64', DataType.e4m3: 'e4m3', DataType.e5m2: 'e5m2', DataType.f16: 'f16', DataType.bf16: 'bf16', DataType.f32: 'f32', DataType.tf32: 'tf32', DataType.f64: 'f64', DataType.cf16: 'cf16', DataType.cbf16: 'cbf16', DataType.cf32: 'cf32', DataType.ctf32: 'ctf32', DataType.cf64: 'cf64', DataType.cu4: 'cu4', DataType.cu8: 'cu8', DataType.cu16: 'cu16', DataType.cu32: 'cu32', DataType.cu64: 'cu64', DataType.cs4: 'cs4', DataType.cs8: 'cs8', DataType.cs16: 'cs16', DataType.cs32: 'cs32', DataType.cs64: 'cs64'}
DataTypeTag = {DataType.void: 'void', DataType.b1: 'cutlass::uint1b_t', DataType.u2: 'cutlass::uint2b_t', DataType.u4: 'cutlass::uint4b_t', DataType.u8: 'uint8_t', DataType.u16: 'uint16_t', DataType.u32: 'uint32_t', DataType.u64: 'uint64_t', DataType.s4: 'cutlass::int4b_t', DataType.s8: 'int8_t', DataType.s16: 'int16_t', DataType.s32: 'int32_t', DataType.s64: 'int64_t', DataType.e4m3: 'cutlass::float_e4m3_t', DataType.e5m2: 'cutlass::float_e5m2_t', DataType.f16: 'cutlass::half_t', DataType.bf16: 'cutlass::bfloat16_t', DataType.f32: 'float', DataType.tf32: 'cutlass::tfloat32_t', DataType.f64: 'double', DataType.cf16: 'cutlass::complex<cutlass::half_t>', DataType.cbf16: 'cutlass::complex<cutlass::bfloat16_t>', DataType.cf32: 'cutlass::complex<float>', DataType.ctf32: 'cutlass::complex<cutlass::tfloat32_t>', DataType.cf64: 'cutlass::complex<double>', DataType.cu4: 'cutlass::complex<cutlass::uint4b_t>', DataType.cu8: 'cutlass::complex<cutlass::uint8_t>', DataType.cu16: 'cutlass::complex<cutlass::uint16_t>', DataType.cu32: 'cutlass::complex<cutlass::uint32_t>', DataType.cu64: 'cutlass::complex<cutlass::uint64_t>', DataType.cs4: 'cutlass::complex<cutlass::int4b_t>', DataType.cs8: 'cutlass::complex<cutlass::int8_t>', DataType.cs16: 'cutlass::complex<cutlass::int16_t>', DataType.cs32: 'cutlass::complex<cutlass::int32_t>', DataType.cs64: 'cutlass::complex<cutlass::int64_t>'}
DataTypeSize = {DataType.void: 0, DataType.b1: 1, DataType.u2: 2, DataType.u4: 4, DataType.u8: 8, DataType.u16: 16, DataType.u32: 32, DataType.u64: 64, DataType.s4: 4, DataType.s8: 8, DataType.s16: 16, DataType.s32: 32, DataType.s64: 64, DataType.e4m3: 8, DataType.e5m2: 8, DataType.f16: 16, DataType.bf16: 16, DataType.f32: 32, DataType.tf32: 32, DataType.f64: 64, DataType.cf16: 32, DataType.cbf16: 32, DataType.cf32: 64, DataType.ctf32: 32, DataType.cf64: 128, DataType.cu4: 8, DataType.cu8: 16, DataType.cu16: 32, DataType.cu32: 64, DataType.cu64: 128, DataType.cs4: 8, DataType.cs8: 16, DataType.cs16: 32, DataType.cs32: 64, DataType.cs64: 128}

class BlasMode(enum.Enum):
    symmetric = enum_auto()
    hermitian = enum_auto()
BlasModeTag = {BlasMode.symmetric: 'cutlass::BlasMode::kSymmetric', BlasMode.hermitian: 'cutlass::BlasMode::kHermitian'}

class ComplexTransform(enum.Enum):
    none = enum_auto()
    conj = enum_auto()
ComplexTransformTag = {ComplexTransform.none: 'cutlass::ComplexTransform::kNone', ComplexTransform.conj: 'cutlass::ComplexTransform::kConjugate'}
ComplexTransformTag3x = {ComplexTransform.none: 'cute::identity', ComplexTransform.conj: 'cute::conjugate'}
RealComplexBijection = [(DataType.f16, DataType.cf16), (DataType.f32, DataType.cf32), (DataType.f64, DataType.cf64)]
...
MathOperationTag = {MathOperation.multiply_add: 'cutlass::arch::OpMultiplyAdd', MathOperation.multiply_add_saturate: 'cutlass::arch::OpMultiplyAddSaturate', MathOperation.multiply_add_mixed_input_upcast: 'cutlass::arch::OpMultiplyAddMixedInputUpcast', MathOperation.xor_popc: 'cutlass::arch::OpXorPopc', MathOperation.and_popc: 'cutlass::arch::OpAndPopc', MathOperation.multiply_add_fast_bf16: 'cutlass::arch::OpMultiplyAddFastBF16', MathOperation.multiply_add_fast_f16: 'cutlass::arch::OpMultiplyAddFastF16', MathOperation.multiply_add_fast_f32: 'cutlass::arch::OpMultiplyAddFastF32', MathOperation.multiply_add_complex_fast_f32: 'cutlass::arch::OpMultiplyAddComplexFastF32', MathOperation.multiply_add_complex: 'cutlass::arch::OpMultiplyAddComplex', MathOperation.multiply_add_complex_gaussian: 'cutlass::arch::OpMultiplyAddGaussianComplex', MathOperation.multiply_add_fast_accum: 'cutlass::arch::OpMultiplyAddFastAccum'}
...
ShortComplexLayoutNames = {(LayoutType.ColumnMajor, ComplexTransform.none): 'n', (LayoutType.ColumnMajor, ComplexTransform.conj): 'c', (LayoutType.RowMajor, ComplexTransform.none): 't', (LayoutType.RowMajor, ComplexTransform.conj): 'h'}
...
class EpilogueScheduleType(enum.Enum):
    ...
    TmaWarpSpecialized = enum_auto()
    TmaWarpSpecializedCooperative = enum_auto()
EpilogueScheduleTag = {EpilogueScheduleType.ScheduleAuto: 'cutlass::epilogue::collective::EpilogueScheduleAuto', EpilogueScheduleType.EpilogueTransposed: 'cutlass::gemm::EpilogueTransposed', EpilogueScheduleType.NoSmemWarpSpecialized: 'cutlass::epilogue::NoSmemWarpSpecialized', EpilogueScheduleType.TmaWarpSpecialized: 'cutlass::epilogue::TmaWarpSpecialized', EpilogueScheduleType.TmaWarpSpecializedCooperative: 'cutlass::epilogue::TmaWarpSpecializedCooperative'}
EpilogueScheduleSuffixes = {EpilogueScheduleType.ScheduleAuto: '', EpilogueScheduleType.EpilogueTransposed: '', EpilogueScheduleType.NoSmemWarpSpecialized: '_epi_nosmem', EpilogueScheduleType.TmaWarpSpecialized: '_epi_tma', EpilogueScheduleType.TmaWarpSpecializedCooperative: '_epi_tma'}

class EpilogueFunctor3x(enum.Enum):
    LinearCombination = enum_auto()
EpilogueFunctor3xTag = {EpilogueFunctor3x.LinearCombination: 'cutlass::epilogue::fusion::LinearCombination'}

class TileSchedulerType(enum.Enum):
    Default = enum_auto()
    Persistent = enum_auto()
    StreamK = enum_auto()
TileSchedulerTag = {TileSchedulerType.Default: 'void', TileSchedulerType.Persistent: 'cutlass::gemm::PersistentScheduler', TileSchedulerType.StreamK: 'cutlass::gemm::StreamKScheduler'}
TileSchedulerSuffixes = {TileSchedulerType.Default: '', TileSchedulerType.Persistent: '', TileSchedulerType.StreamK: '_stream_k'}
...
OpcodeClassNames = {OpcodeClass.Simt: 'simt', OpcodeClass.TensorOp: 'tensorop', OpcodeClass.WmmaTensorOp: 'wmma_tensorop', OpcodeClass.SparseTensorOp: 'sptensorop'}
OpcodeClassTag = {OpcodeClass.Simt: 'cutlass::arch::OpClassSimt', OpcodeClass.TensorOp: 'cutlass::arch::OpClassTensorOp', OpcodeClass.WmmaTensorOp: 'cutlass::arch::OpClassWmmaTensorOp', OpcodeClass.SparseTensorOp: 'cutlass::arch::OpClassSparseTensorOp'}
...
class OperationKind(enum.Enum):
    ...
    Conv2d = enum_auto()
    Conv3d = enum_auto()
OperationKindNames = {OperationKind.Gemm: 'gemm', OperationKind.RankK: 'rank_k', OperationKind.Rank2K: 'rank_2k', OperationKind.Trmm: 'trmm', OperationKind.Symm: 'symm', OperationKind.Conv2d: 'conv2d', OperationKind.Conv3d: 'conv3d'}

class Target(enum.Enum):
    library = enum_auto()
ArchitectureNames = {50: 'maxwell', 60: 'pascal', 61: 'pascal', 70: 'volta', 75: 'turing', 80: 'ampere', 89: 'ada', 90: 'hopper'}
SharedMemPerCC = {70: 96, 72: 96, 75: 64, 80: 163, 86: 99, 87: 163, 89: 99, 90: 227}
...
class GemmKind(enum.Enum):
    ...
    Grouped = enum_auto()
GemmKindNames = {GemmKind.Gemm: 'gemm', GemmKind.Sparse: 'spgemm', GemmKind.Universal: 'gemm', GemmKind.Universal3x: 'gemm', GemmKind.SparseUniversal3x: 'spgemm', GemmKind.PlanarComplex: 'gemm_planar_complex', GemmKind.PlanarComplexArray: 'gemm_planar_complex_array', GemmKind.Grouped: 'gemm_grouped'}
...
EpilogueFunctorTag = {EpilogueFunctor.LinearCombination: 'cutlass::epilogue::thread::LinearCombination', EpilogueFunctor.LinearCombinationClamp: 'cutlass::epilogue::thread::LinearCombinationClamp'}
...
class GroupScheduleMode(enum.Enum):
    Device = (enum_auto(),)
    Host = enum_auto()
GroupScheduleModeTag = {GroupScheduleMode.Device: 'cutlass::gemm::kernel::GroupScheduleMode::kDeviceOnly', GroupScheduleMode.Host: 'cutlass::gemm::kernel::GroupScheduleMode::kHostPrecompute'}
...
class ConvKind(enum.IntEnum):
    ...
    Dgrad = 1
    Wgrad = 2
ConvKindTag = {ConvKind.Fprop: 'cutlass::conv::Operator::kFprop', ConvKind.Dgrad: 'cutlass::conv::Operator::kDgrad', ConvKind.Wgrad: 'cutlass::conv::Operator::kWgrad'}
...
IteratorAlgorithmTag = {IteratorAlgorithm.Analytic: 'cutlass::conv::IteratorAlgorithm::kAnalytic', IteratorAlgorithm.Optimized: 'cutlass::conv::IteratorAlgorithm::kOptimized', IteratorAlgorithm.FixedChannels: 'cutlass::conv::IteratorAlgorithm::kFixedChannels', IteratorAlgorithm.FewChannels: 'cutlass::conv::IteratorAlgorithm::kFewChannels', IteratorAlgorithm.FixedStrideDilation: 'cutlass::conv::IteratorAlgorithm::kFixedStrideDilation'}
IteratorAlgorithmNames = {IteratorAlgorithm.Analytic: 'analytic', IteratorAlgorithm.Optimized: 'optimized', IteratorAlgorithm.FixedChannels: 'fixed_channels', IteratorAlgorithm.FewChannels: 'few_channels', IteratorAlgorithm.FixedStrideDilation: 'fixed_stride_dilation'}

class StrideSupport(enum.Enum):
    Strided = 0
    Unity = 1
    Fixed = 2
StrideSupportTag = {StrideSupport.Strided: 'cutlass::conv::StrideSupport::kStrided', StrideSupport.Unity: 'cutlass::conv::StrideSupport::kUnity', StrideSupport.Fixed: 'cutlass::conv::StrideSupport::kFixed'}
StrideSupportNames = {StrideSupport.Strided: '', StrideSupport.Unity: 'unity_stride', StrideSupport.Fixed: 'fixed_stride'}
...
class GroupMode(enum.Enum):
    ...
    Depthwise = enum_auto()
GroupModeTag = {GroupMode.NoneGroup: 'cutlass::conv::GroupMode::kNone', GroupMode.SingleGroup: 'cutlass::conv::GroupMode::kSingleGroup', GroupMode.MultipleGroup: 'cutlass::conv::GroupMode::kMultipleGroup', GroupMode.Depthwise: 'cutlass::conv::GroupMode::kDepthwise'}
GroupModeNames = {GroupMode.NoneGroup: '', GroupMode.SingleGroup: 'single_group', GroupMode.MultipleGroup: 'multiple_group', GroupMode.Depthwise: 'depthwise'}
...
class Direct2dConvFixedStrideDilationTileDescription:
    ...
    def procedural_name(self):
        str_name = '%dx%dx%d_%dx%dx%dx%d_%d_filter%dx%d' % (self.threadblock_shape[0], self.threadblock_shape[1], self.threadblock_shape[2], self.threadblock_output_shape[0], self.threadblock_output_shape[1], self.threadblock_output_shape[2], self.threadblock_output_shape[3], self.stages, self.filter_shape[0], self.filter_shape[1])
        if self.stride != [-1, -1] and self.dilation != [-1, -1]:
            str_name += '_stride%dx%d_dilation%dx%d' % (self.stride[0], self.stride[1], self.dilation[0], self.dilation[1])
        return str_name
...
def CalculateSmemUsage(operation):
    ...
    if operation.operation_kind == OperationKind.Gemm and operation.gemm_kind == GemmKind.Sparse:
        ...
        smem_per_stage = DataTypeSize[operation.A.element] * cta_shape[0] * (cta_shape[2] // 2) // 8 + DataTypeSize[operation.B.element] * cta_shape[1] * cta_shape[2] // 8 + cta_shape[0] * (cta_shape[2] // 2) // elements_per_8b_md
    else:
        ...
        smem_per_stage = data_type_size_a * cta_shape[0] * cta_shape[2] // 8 + data_type_size_b * cta_shape[1] * cta_shape[2] // 8
