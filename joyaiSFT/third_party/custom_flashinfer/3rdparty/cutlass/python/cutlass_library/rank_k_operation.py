...
class RankKOperation:
    ...
    def __init__(self, rank_k_kind, arch, tile_description, A, C, element_epilogue, epilogue_functor=EpilogueFunctor.LinearCombination, swizzling_functor=SwizzlingFunctor.Identity8, blas_mode=BlasMode.symmetric):
    ...
    def procedural_name(self):
        ...
        return SubstituteTemplate('cutlass_${opcode_class}_${extended_name}_${threadblock}_${layout}_${fill_mode}_align${alignment}', {'opcode_class': opcode_class_name, 'extended_name': self.extended_name(), 'threadblock': threadblock, 'layout': self.layout_name(), 'fill_mode': self.fill_mode_name(), 'alignment': '%d' % self.A.alignment})
...
class EmitRankKConfigurationLibrary:
    ...
    def __init__(self, operation_path, configuration_name):
        ...
        self.instance_emitter = {RankKKind.Universal: EmitRankKUniversalInstance}
        self.rank_k_kind_wrappers = {RankKKind.Universal: 'RankKOperation'}
        self.instance_template = {RankKKind.Universal: '\n${compile_guard_start}\n  manifest.append(new ${rank_k_kind}<\n    Operation_${operation_name}\n  >("${operation_name}"));\n${compile_guard_end}\n'}
