...
class TestEVTLoad(EVTTestCaseBase):
    ...
    def test_tensor_load(self):
        ...
        for m, n, k, l in self.get_problem_sizes(8):
            example_inputs = {'accum': self.fake_tensor(self.element, (l, m, n)), 'C': self.fake_tensor(self.element, (l, m, n)), 'aux': self.fake_tensor(self.element, (m, n)), 'aux_batch': self.fake_tensor(np.float32, (l, m, n)), 'D': self.fake_tensor(self.element, (l, m, n))}
    ...
    def test_row_broadcast(self):
        ...
        def evt_row_broadcast(accum, C, bias, bias_batch):
            ...
            return D
        for m, n, k, l in self.get_problem_sizes(8):
            example_inputs = {'accum': self.fake_tensor(self.element, (l, m, n)), 'C': self.fake_tensor(self.element, (l, m, n)), 'bias': self.fake_tensor(self.element, (n,)), 'bias_batch': self.fake_tensor(np.float32, (l, 1, n)), 'D': self.fake_tensor(self.element, (l, m, n))}
    ...
    def test_column_broadcast(self):
        ...
        def evt_column_broadcast(accum, C, bias, bias_batch):
            ...
            return D
        for m, n, k, l in self.get_problem_sizes(8):
            example_inputs = {'accum': self.fake_tensor(self.element, (l, m, n)), 'C': self.fake_tensor(self.element, (l, m, n)), 'bias': self.fake_tensor(self.element, (m, 1)), 'bias_batch': self.fake_tensor(np.float32, (l, m, 1)), 'D': self.fake_tensor(self.element, (l, m, n))}
    ...
    def test_scalar_broadcast(self):
        ...
        def evt_scalar_broadcast(accum, C, alpha, alpha_batch):
            ...
            return D
        for m, n, k, l in self.get_problem_sizes(8):
            example_inputs = {'accum': self.fake_tensor(self.element, (l, m, n)), 'C': self.fake_tensor(self.element, (l, m, n)), 'alpha': 0.5, 'alpha_batch': self.fake_tensor(np.float32, (l, 1, 1)), 'D': self.fake_tensor(self.element, (l, m, n))}
