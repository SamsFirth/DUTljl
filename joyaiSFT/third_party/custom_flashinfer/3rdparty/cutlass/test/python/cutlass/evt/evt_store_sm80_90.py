...
class TestEVTStore(EVTTestCaseBase):
    ...
    def test_col_reduce(self):
        ...
        for m, n, k, l in self.get_problem_sizes(8):
            example_inputs = {'accum': self.fake_tensor(self.element, (l, m, n)), 'alpha': 2.0, 'C': self.fake_tensor(self.element, (l, m, n)), 'F_row_max': self.fake_tensor(np.float32, (m, 1)), 'acc_row_max': self.fake_tensor(np.float32, (l, m, 1)), 'D': self.fake_tensor(self.element, (l, m, n))}
    ...
    def test_row_reduce(self):
        ...
        for m, n, k, l in self.get_problem_sizes(8):
            example_inputs = {'accum': self.fake_tensor(self.element, (l, m, n)), 'alpha': 2.0, 'C': self.fake_tensor(self.element, (l, m, n)), 'F_col_max': self.fake_tensor(np.float32, (n,)), 'acc_col_max': self.fake_tensor(np.float32, (l, 1, n)), 'D': self.fake_tensor(self.element, (l, m, n))}
    ...
    def test_scalar_reduce(self):
        ...
        for m, n, k, l in self.get_problem_sizes(8):
            example_inputs = {'accum': self.fake_tensor(self.element, (l, m, n)), 'alpha': 2.0, 'C': self.fake_tensor(self.element, (l, m, n)), 'acc_max': self.fake_tensor(np.float32, (l, 1, 1)), 'F_max': self.fake_tensor(np.float32, (1,)), 'D': self.fake_tensor(self.element, (l, m, n))}
