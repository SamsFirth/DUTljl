...
import cutlass
from cutlass_library import DataTypeNames, EpilogueScheduleSuffixes, KernelScheduleSuffixes, LayoutType, OpcodeClassNames, ShortDataTypeNames, ShortLayoutTypeNames
...
def get_name(layouts, alignments, element_output, element_accumulator, element_epilogue, cluster_shape, threadblock_shape, stages, element_a, element_b, element_c, arch, opclass, kernel_schedule=None, epilogue_schedule=None, suffix=''):
    """
...
def add_test_gemm(cls=None, cc=None, element=None, layouts=None, alignments=None, element_output=None, element_accumulator=None, cluster_shape=None, threadblock_shape=None, warp_count=None, stages=None, opclass=None, swizzle=None, kernel_schedule=None, epilogue_schedule=None, compilation_modes=['nvcc', 'nvrtc'], element_A=None, element_B=None, element_C=None):
    ...
    for compilation_mode in compilation_modes:
        ...
        def run(self):
            ...
            plan = cutlass.op.Gemm(element_A=element_A, element_B=element_B, element_C=element_C, element_D=element_output, layout_A=layout_A, layout_B=layout_B, layout_C=layout_C, element_accumulator=element_accumulator, kernel_cc=cc)
