...
for_cutlass_gen_user_include_header_file = [cutlass_deps_root + 'cutlass/epilogue/thread/linear_combination_leaky_relu.h', cutlass_deps_root + 'cutlass/epilogue/thread/linear_combination.h']
for_fused_wrapper = [cutlass_deps_root + 'cutlass/epilogue/thread/linear_combination_leaky_relu.h', cutlass_deps_root + 'cutlass/epilogue/thread/linear_combination.h', 'auto_gen/device/' + gen_name + '.h', cutlass_deps_root + 'cutlass/gemm/device/gemm_batched.h', cutlass_deps_root + 'cutlass/cutlass.h']
