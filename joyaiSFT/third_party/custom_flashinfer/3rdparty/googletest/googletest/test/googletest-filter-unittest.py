...
DISABLED_BANNER_REGEX = re.compile('^\\[\\s*DISABLED\\s*\\] (.*)')
...
class GTestFilterUnitTest(gtest_test_utils.TestCase):
    ...
    def testShardStatusFileIsCreatedWithListTests(self):
        ...
        try:
            ...
            self.assertTrue('[==========]' not in output, 'Unexpected output during test enumeration.\nPlease ensure that LIST_TESTS_FLAG is assigned the\ncorrect flag value for listing Google Test tests.')
            self.assertTrue(os.path.exists(shard_status_file))
            os.remove(shard_status_file)
    ...
    def testDisabledBanner(self):
        ...
        self.AssertSetEqual(banners, ['BarTest.DISABLED_TestFour', 'BarTest.DISABLED_TestFive', 'BazTest.DISABLED_TestC'])
        banners = RunAndExtractDisabledBannerList(make_filter('Bar*'))
        self.AssertSetEqual(banners, ['BarTest.DISABLED_TestFour', 'BarTest.DISABLED_TestFive'])
        banners = RunAndExtractDisabledBannerList(make_filter('*-Bar*'))
