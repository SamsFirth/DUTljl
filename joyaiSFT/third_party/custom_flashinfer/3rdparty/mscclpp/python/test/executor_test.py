from os import path
from mscclpp import DataType, Executor, ExecutionPlan
...
if __name__ == '__main__':
    ...
    execution_time = bench_time(100, 10, lambda stream: executor.execute(MPI.COMM_WORLD.rank, sendbuf.data.ptr, sendbuf.data.ptr, sendbuf.nbytes, sendbuf.nbytes, DataType.float16, 512, execution_plan, stream.ptr))
