...
def _monkeypatch_add_torch_compile(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if compiled is None:
            func(*args, **kwargs)
            compiled = torch.compile(func, fullgraph=True, backend='inductor', mode='max-autotune-no-cudagraphs')
