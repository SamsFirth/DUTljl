...
def warmup_jit():
    if flashinfer.jit.has_prebuilt_ops:
        ...
        try:
            flashinfer.jit.parallel_load_modules([(flashinfer.activation.get_act_and_mul_module, ['silu']), (flashinfer.activation.get_act_and_mul_module, ['gelu']), (flashinfer.activation.get_act_and_mul_module, ['gelu_tanh'])])
