...
class CustomSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def __init__(self, finetuning_args: 'FinetuningArguments', processor: Optional['ProcessorMixin'], model_args: Optional['ModelArguments']=None, gen_kwargs: Optional[dict[str, Any]]=None, **kwargs) -> None:
    ...
    @override
    def prediction_step(self, model: 'torch.nn.Module', inputs: dict[str, Union['torch.Tensor', Any]], prediction_loss_only: bool, ignore_keys: Optional[list[str]]=None, **gen_kwargs) -> tuple[Optional[float], Optional['torch.Tensor'], Optional['torch.Tensor']]:
