...
def print_env() -> None:
    ...
    info = OrderedDict({'`jdea` version': VERSION, 'Platform': platform.platform(), 'Python version': platform.python_version(), 'PyTorch version': torch.__version__, 'Transformers version': transformers.__version__, 'Datasets version': datasets.__version__, 'Accelerate version': accelerate.__version__, 'PEFT version': peft.__version__})
